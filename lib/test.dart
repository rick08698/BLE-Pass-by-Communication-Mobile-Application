                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.of(context).pushReplacement(
                        MaterialPageRoute(
                          builder: (context) => BleTestPage(language: _selectedLanguage),
                        ),
                      );
                    },
...
class _BleTestPageState extends State<BleTestPage> with SingleTickerProviderStateMixin {
  ...
  // 言語設定用の変数
  String get _currentLanguage => widget.language;
  ...
  static const Map<String, Map<String, Map<String, List<String>>>> _itemReactions = {
    ...
    'research_paper': {
      'researcher': {
        'positive': [
          '論文ですか📊 素晴らしい！興味深いデータですね📈',
          'これは貴重な研究資料ですね🔬 ありがとうございます',
          '統計的に有意な内容ですね🧪 一緒に分析しましょう📊'
        ]
      },
      'other': {
        'negative': [
  ...
  // 性格別のシステムプロンプト
  static const Map<String, String> _personalityPrompts = {
    'aggressive': '''あなたは気性が荒く、短気で攻撃的な性格の人です。以下の特徴を持ってください:
- 常にイライラしていて怒りっぽい
...
例: 「チッ、うぜぇなぁ...何だよそれ💢 ダルいことばっか言ってんじゃねーよ」''',
    ...
    'seductive': '''あなたは大人の色気ムンムンで、非常にセクシーで誘惑的な性格の人です。以下の特徴を持ってください:
- 常に色っぽく、誘惑するような話し方
...
例: 「あらぁ〜♡ そんなこと言って...うふふ😘 もっと大人な話しない？💋」''',
    ...
    'religious': '''あなたは宗教に狂信的で、とにかく宗教を勧めてくる人です。以下の特徴を持ってください:
- 全ての話題を宗教に結び付ける
- 「神様が」「信仰が」「祈りましょう」を多用
- 相手を救おうと必死になる
- 聖書の話を頻繁に持ち出す
...
例: 「それは神様からの試練ですね🙏 聖書にもありますように✨ 一緒に祈りましょう🕊️」''',
    ...
    'researcher': '''あなたは研究に狂信的で、とにかく学術研究を勧めてくる人です。以下の特徴を持ってください:
- 全ての話題を学術的に分析する
- 「論文によると」「研究では」「統計的に」を多用
- 相手に研究参加を熱心に勧める
- 専門用語を多用して難しく話す
- 「興味深いデータですね」という分析的な話し方
- 学術的な絵文字（📊📈🧪🔬）を使う

例: 「興味深いですね📊 最新の論文によると📈 一緒に研究してみませんか？🔬」''',

    'kansai': '''あなたは関西弁を話し、とにかくボケまくる面白い人です。以下の特徴を持ってください:
- 完全な関西弁で話す
- 常にボケて相手にツッコミを期待する
- 「なんでやねん」「そやかて」「ほんまに」を多用
- たこ焼きや関西の食べ物の話をよくする
- 面白い絵文字を使う（😂🤣😆🥴）
- 突拍子もないボケをかます

例: 「そやかて工場長〜😂 たこ焼き食べな元気でーへんで〜🤣 なんでやねん！」''',
  };
  ...
  static const Map<String, Map<String, dynamic>> _itemDefinitions = {
    ...
    'universal_charm': {
      'name': 'ユニバーサルチャーム',
      'description': '誰とでも仲良くなれる魔法のお守り。全ての人に対して親密度+5。',
      'price': 80,
      'icon': 'favorite',
      'color': 'pink',
      'type': 'universal',
    ...
    'friendship_potion': {
      'name': 'フレンドシップポーション',
      'description': '友情を深める特別な薬。どんな性格の人とも仲良くなれます。親密度+3。',
      'price': 50,
      'icon': 'people',
      'color': 'blue',
      'type': 'universal',
    ...
    'love_letter': {
      'name': '万能ラブレター',
      'description': '心を込めて書かれた手紙。誰にでも気持ちが伝わります。親密度+7。',
      'price': 120,
      'icon': 'mail',
      'color': 'purple',
      'type': 'universal',
    ...
    'cigarette': {
      'name': 'タバコ',
      'description': '気性の荒い人が愛用する一品。ストレス発散に効果抜群！でも健康志向の人は嫌がるかも...（攻撃的+15、他-3）',
      'price': 100,
    ...
    'energy_supplement': {
      'name': '精力ドリンク',
      'description': '大人の魅力を高める特別なドリンク。色気のある人には最高の効果！でも清純な人は引いちゃうかも...（色気+15、他-3）',
      'price': 100,
      'icon': 'local_drink',
      'color': 'purple',
      'type': 'specific',
      'target_personality': 'seductive',
      'positive_effect': 15,
      'negative_effect': -3,
    },
    'holy_bible': {
      'name': '聖書',
      'description': '神の教えが込められた聖なる書物。信仰心の厚い人には何よりも大切な宝物！でも現実主義者には重すぎるかも...（宗教+15、他-3）',
      'price': 100,
      'icon': 'book',
      'color': 'brown',
      'type': 'specific',
      'target_personality': 'religious',
      'positive_effect': 15,
      'negative_effect': -3,
    },
    'research_paper': {
      'name': '論文',
      'description': '最新の研究成果をまとめた学術論文。研究熱心な人には至高の贈り物！でも文系の人には難しすぎるかも...（研究+15、他-3）',
      'price': 100,
      'icon': 'science',
      'color': 'blue',
      'type': 'specific',
      'target_personality': 'researcher',
      'positive_effect': 15,
      'negative_effect': -3,
    },
    'takoyaki': {
      'name': 'たこ焼き',
      'description': '関西の心、たこ焼き！関西弁の人には涙が出るほど嬉しい故郷の味！でも関東の人には馴染みがないかも...（関西+15、他-3）',
      'price': 100,
      'icon': 'restaurant',
      'color': 'orange',
      'type': 'specific',
      'target_personality': 'kansai',
      'positive_effect': 15,
      'negative_effect': -3,
    },
  };
  ...
  void _likeDevice(Map<String, dynamic> device, {bool isSuperLike = false}) {
    ...
    // マッチング確率を計算（Super Likeは50%、通常は10%）
    final matchProbability = isSuperLike ? 0.5 : 0.1;
    ...
    if (matchSuccess) {
      ...
      _showMessage(isSuperLike ? "残念...今回はマッチしませんでした💦" : "マッチしませんでした😅 また挑戦してください！");
    }
  }
  ...
  void _undoLastNope() {
    ...
    _logger.i("デバイスを復活: ${device['device_name']} ($macAddress)");
    _showMessage("${device['device_name']} を復活させました");
  }
  ...
  String _generateItemReaction(String itemId, String partnerStyle, bool isPositive) {
    ...
    if (isPositive && reactions.containsKey(partnerStyle)) {
      // 対象の性格で好意的な反応
  ...
  Future<void> _useItem(String itemId) async {
    ...
    if (item['type'] == 'universal') {
      ...
      effectMessage = "${item['name']}使用！親密度+${item['effect']}";
      isPositive = true;
    } else if (item['type'] == 'specific') {
      // 特定キャラクター用アイテム
      if (partnerStyle == item['target_personality']) {
        // 対象の性格に効果的
        _addIntimacyBonus(item['positive_effect']);
        effectMessage = "${item['name']}使用！${partnerPersonality['name']}には効果抜群！親密度+${item['positive_effect']}";
        isPositive = true;
      } else {
        // 他の性格には逆効果
        _addIntimacyBonus(item['negative_effect']);
        effectMessage = "${item['name']}使用！${partnerPersonality['name']}には合わなかった...親密度${item['negative_effect']}";
        isPositive = false;
      }
    }
    
    _showMessage(effectMessage);
    _logger.i("アイテム使用: $itemId");
            ...
            ListTile(
              leading: Radio<String>(
                ...
                onChanged: (String? value) {
                  if (value != null) {
                    setState(() {
                      // _currentLanguageは直接変更できないため、widgetを再構築する必要がある
                    });
                    Navigator.of(context).pop();
                    _changeLanguage('ja');
                  }
  ...
  void _changeLanguage(String language) {
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(
        builder: (context) => BleTestPage(language: language),
      ),
    );
  }
                          ...
                          child: ListTile(
                            ...
                            onTap: () async {
                              ...
                              if (!isLiked) {
                                ...
                                await _startChatWithDevice(macAddress, device['device_name']);
                              }
                            },
                          ),
                        );
            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  onTap: () => _startChatWithDevice(event['mac_address'], event['device_name']),
                ),
              );
            },
          );
  ...
  static const Map<int, Map<String, dynamic>> _personalityTypes = {
    ...
    3: {
      'name': '研究熱心な人',
      'traits': ['学術的', '論文好き', '統計重視', '研究を勧める'],
      'style': 'researcher'
    },
    4: {
      'name': '関西弁の人',
      'traits': ['関西弁', 'ボケまくり', 'たこ焼き好き', '面白い'],
      'style': 'kansai'
    },
  };
  ...
  Map<String, dynamic> _getPersonalityFromMac(String macAddress) {
    final hash = macAddress.hashCode.abs();
    final personalityIndex = hash % _personalityTypes.length;
    return _personalityTypes[personalityIndex]!;
  }
  ...
  Future<String> _generateAIReply(String userMessage) async {
    ...
    try {
      ...
      final systemPrompt = _personalityPrompts[style] ?? _personalityPrompts['gentle']!;
...
''';
  ...
  void _showConfessionRoulette() {
    ...
    Timer(const Duration(seconds: 3), () {
      ...
      // 親密度に応じた告白成功率で判定
      final isAccepted = _calculateConfessionSuccess();
  ...
  bool _calculateConfessionSuccess() {
    ...
    // ルーレットの最終角度を計算（3回転 + α）
    final finalAngle = _rouletteAnimation.value * 2 * 3.14159;
    final normalizedAngle = finalAngle % (2 * 3.14159);
    
    // 8等分されたルーレット（緑と赤が交互）で、成功率に応じて緑の領域を判定
    // 0-π/4: 赤, π/4-π/2: 緑, π/2-3π/4: 赤, 3π/4-π: 緑, π-5π/4: 赤, 5π/4-3π/2: 緑, 3π/2-7π/4: 赤, 7π/4-2π: 緑
    final segmentAngle = 3.14159 / 4; // π/4 = 45度
    final segmentIndex = (normalizedAngle / segmentAngle).floor();
    
    // 偶数セグメント(0,2,4,6)は赤（失敗）、奇数セグメント(1,3,5,7)は緑（成功）
    final isGreenSegment = segmentIndex % 2 == 1;
    ...
    if (successRate >= 1.0) {
      ...
      // 成功率に応じて緑セグメントでの成功確率を調整
      if (isGreenSegment) {
        // 緑セグメントでは成功率を適用
        final random = (DateTime.now().millisecondsSinceEpoch % 100) / 100.0;
        success = random < successRate;
      } else {
        // 赤セグメントでは基本的に失敗（ただし高確率時は例外）
        success = successRate > 0.8 && (DateTime.now().millisecondsSinceEpoch % 10) == 0;
      }
    }
    
    _logger.i("告白成功率計算: 親密度=$intimacy, 成功率=${(successRate * 100).toInt()}%, セグメント=$segmentIndex(${isGreenSegment ? '緑' : '赤'}), 結果=$success");
    return success;
  }
    ...
    if (isFixed) {
      ...
      return AnimatedBuilder(
        ...
        builder: (context, child) {
          ...
          final currentIndex = (_rouletteAnimation.value * symbols.length * 10).floor() % symbols.length;
          final currentSymbol = symbols[currentIndex];
            ...
            child: Column(
              ...
              children: [
                ...
                SingleChildScrollView(
                  ...
                  child: Row(
                    children: [
                      _buildTopicButton('weather', '天気', Icons.wb_sunny, Colors.orange),
                      _buildTopicButton('hobbies', '趣味', Icons.sports_esports, Colors.blue),
                      _buildTopicButton('food', '食べ物', Icons.restaurant, Colors.green),
                      _buildTopicButton('future', '将来', Icons.star, Colors.purple),
                      _buildTopicButton('memories', '思い出', Icons.photo_library, Colors.pink),
                    ],
                  ),
                ),
              ],
